...
import { Code, Settings2, ShieldCheck } from "lucide-react";
			...
			<div className="@container mx-auto max-w-5xl px-6">
				<div className="text-center">
					<h2 className="text-balance text-4xl font-semibold lg:text-5xl">
						Tailor made for developers like you.
					</h2>
					<p className="mt-4">
						Smart, powerful and user friendly - just about everything you need
				...
				<div className="@min-4xl:max-w-full @min-4xl:grid-cols-3 mx-auto mt-8 grid max-w-sm gap-6 *:text-center md:mt-16">
					<Card className="group bg-background">
						<CardHeader className="pb-3">
							...
							<h3 className="mt-6 font-medium">Flexible</h3>
						</CardHeader>
					...
					<Card className="group bg-background">
						...
						<CardContent>
							<p className="mt-3 text-sm">
								...
								end-to-end encryption gives you full control.{" "}
							</p>
						</CardContent>
					</Card>
				</div>
